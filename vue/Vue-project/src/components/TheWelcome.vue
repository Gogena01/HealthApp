...
<template>
  <WelcomeItem>
    ...
    <template #heading>Importance of healthy life</template>
    ...
    If you want some tips <a href="/healthyLiving">Click here</a>
  ...
  <WelcomeItem>
    ...
    If you want to learn more about the sports, click on the link below
    and find the information that you are searching for
    <a href="http://127.0.0.1:5173/sports" target="_blank" rel="noopener">Sports</a>
